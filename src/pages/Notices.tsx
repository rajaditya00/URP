...
const SEED_NOTICES = [
  ...
  { id: 2, title: 'Call for Proposals: Annual Tech Fest', dept: 'Student Council', date: 'Oct 10, 2026', type: 'General', desc: 'IntelliQ is inviting comprehensive proposals from engineering students and clubs for organizing events at the upcoming Annual Tech Fest. Outstanding ideas will receive university seed funding.' },
  { id: 3, title: 'Maintenance Shutdown of University ERP', dept: 'IT Services', date: 'Oct 08, 2026', type: 'Alert', desc: 'The IntelliQ Portal will undergo scheduled system upgrades and server database indexing on October 14th from 02:00 AM to 06:00 AM. Access will be temporarily unavailable.' },
